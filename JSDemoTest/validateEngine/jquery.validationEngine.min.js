...
//验证登陆账号
function validateUserCode(field, rules, i, options){
   var value = field.val();
	//使用正则表达式
	var reg = /^\w{5,30}$/;     
    var r = value.match(reg);
    if(r==null){
    	return '请填写5-30位数字字母下划线!'; 
    }
}
//验证手机号
function validateCellPhone(field, rules, i, options){
...
function validateIdCard(field, rules, i, options){
